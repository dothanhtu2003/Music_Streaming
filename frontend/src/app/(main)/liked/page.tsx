...
export default function LikedPage() {
  ...
  return (
    <div className="space-y-8 page-fade-in">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-zinc-800/80 bg-gradient-to-b from-emerald-950/40 via-zinc-950 to-black p-6 shadow-2xl sm:p-8">
      ...
      <div className="space-y-4">
        {authLoading && (
          <SongList songs={[]} loading emptyMessage="Loading liked songs..." />
        )}
