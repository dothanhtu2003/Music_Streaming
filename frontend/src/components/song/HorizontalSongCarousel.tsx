      ...
      <div className="flex items-end justify-between gap-4 border-b border-zinc-900 pb-2">
        ...
        <div className="hidden shrink-0 items-center gap-2 md:flex">
          {viewAllHref && (
            <Link
              href={viewAllHref}
              className="rounded-full border border-zinc-800 px-3 py-2 text-xs font-semibold text-zinc-400 transition hover:border-green-500/40 hover:text-white"
            >
              View all
            </Link>
          )}
          {!loading && songs.length > 0 && (
            <>
              <button
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-zinc-800 bg-zinc-950 text-zinc-300 transition hover:border-green-500/40 hover:text-white disabled:cursor-not-allowed disabled:opacity-35"
              >
          ...
          {canLoadMore && onLoadMore && (
            <div className="flex justify-center pt-2">
              <button
                ...
                className="rounded-full border border-zinc-800 px-5 py-2 text-xs font-semibold text-zinc-300 transition hover:border-green-500 hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
              >
